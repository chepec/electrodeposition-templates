...
setwd("/home/taha/chepec/chetex/LAB-REPORTS/templates/amperometry")
...
\mc{1}{|c|}{%
   ...
   \begin{tikzpicture}[font=\footnotesize\bfseries, style=thick]
      ...
      \node [inner sep=0pt,above right] 
         {\includegraphics[width=1.5in]{/home/taha/chepec/instruments/CHI760/teflon-cap-no-annot.pdf}};
