...
setwd("/home/taha/chepec/chetex/LAB-REPORTS/templates/amperometry-metrohm-cell")
...
\mc{2}{|l|}{\celltitle{Deposit area (geometric)/\si{\square\centi\metre}}} & \mc{3}{l}{\celltitle{Deposit appearance}} & \mc{1}{|l|}{\celltitle{Deposit mass/\si{\milli\gram}}}\\
...
\mc{6}{l}{Electrolyte}\\\hline
 &  &  &  &  & \\[-12pt]
\mc{3}{|l|}{\celltitle{Electrolyte id}} & \mc{3}{l|}{\celltitle{Precursors}}\\
\mc{3}{|r|}{\Sexpr{obs$electrolyte.id}} & \mc{3}{r|}{\Sexpr{obs$electrolyte.precursors}}\\\hline
...
\mc{1}{l}{Cell inlets/outlets}\\\hline
\\[-12pt]
\mc{1}{|c|}{}\\
\mc{1}{|c|}{%
   %\tikzexternaldisable
   ...
   \begin{tikzpicture}[font=\footnotesize\bfseries, style=thick]
      ...
      \node [inner sep=0pt,above right] 
         {\includegraphics[width=2.5in]{metrohm-lid-photos/zenith-photocopy.png}};
